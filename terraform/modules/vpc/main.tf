# Module VPC - Architecture Hybride Multi-AZ
# Réseau sécurisé avec sous-réseaux publics et privés
...
# Sous-réseaux publics (DMZ) - 2 AZ pour haute disponibilité
...
# Sous-réseaux privés (Applications) - 2 AZ
